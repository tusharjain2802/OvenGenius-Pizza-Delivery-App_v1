...
export default function Signup() {
  ...
  return (
    <div style={{ backgroundImage: 'url("https://images.pexels.com/photos/1166120/pexels-photo-1166120.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1")', backgroundSize: 'cover',height: '100vh' }}>
      <div>
      <Navbar />
      </div>
        ...
        <div className='container' >
          <form className='w-50 m-auto mt-5 border bg-dark border-success rounded' onSubmit={handleSubmit}>
            ...
            <div className="m-3">
              ...
              <input type="number" className="form-control" name='phone' value={credentials.phone} onChange={onChange} aria-describedby="emailHelp" />
            </div>
            <div className="m-3">
